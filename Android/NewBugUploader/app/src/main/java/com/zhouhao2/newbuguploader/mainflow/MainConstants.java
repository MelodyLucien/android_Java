...
public class MainConstants {
    ...
    // some file's path
    public static final String COMPRESSED_TO_PATH_DIR = "/data/data/com.hisense.bugreport2ftp/";
    public static final String APP_HOME_BUG_DIR = "/data/data/com.hisense.bugreport2ftp/bug/";
    ...
    public static String getUploadFileName(Context context) {
        ...
        if (serialNumber == null) {
            ...
            return serialNumber + "_" + timeNow + ".zip";
        }
        return null;
    }
