...
public class SFtpUploader {
    ...
    public void uploadFile(final String TAG, final Handler mHandler,
            final String compressesFileNamePath,
            final String compressesFileName, final Context context) {
        new Thread() {
            public void run() {
                ...
                try {
                    ...
                    mMoniter = new SftpProgressMonitor() {
                        ...
                        public void end() {
                            ...
                            mHandler.sendEmptyMessage(MainConstants.UPLOAD_SUCCESS);
                        }
