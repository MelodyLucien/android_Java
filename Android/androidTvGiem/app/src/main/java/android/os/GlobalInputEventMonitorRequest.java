...
public class GlobalInputEventMonitorRequest implements Parcelable {
    ...
    public enum InputEventType implements Parcelable {
        ...
        public static final Creator<InputEventType> CREATOR = new Creator<InputEventType>() {
    ...
    public static final Creator<GlobalInputEventMonitorRequest> CREATOR = new Creator<GlobalInputEventMonitorRequest>() {
